...
class CrimeSpider:
    ...
    def spider_main(self):
        for page in range(2266, 11000):#3536-3538,3734,3742,3773,4908,5070，10450，10452-10999失败了；
            try:
    ...
    def inspect_crawl(self):
        for page in range(1, 3685):#现在是3679
            try:
                ...
                data['url']= url
                data['html'] = html
                self.db['jc'].insert_one(data)#检查项目页面集合
